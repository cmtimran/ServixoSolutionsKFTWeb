...
const translations: Record<Language, Record<string, string>> = {
  EN: {
    ...
    'checkout.declaration_text': 'I hereby acknowledge that my following personal data stored by the data controller Servixo Solutions Kft. (1081 Budapest, Rákóczi út 63.) in the user database https://servixosolutionskft.com will be transferred to SimplePay Plc., as data processor. The scope of data transferred by the controller: Name, email address, billing address.\n\nThe nature and purpose of the data processing operations performed by the processor are available in the SimplePay Privacy Policy at the following link: https://simplepay.hu/adatkezelesi-tajekoztatok/',
  ...
  HU: {
    ...
    'checkout.declaration_text': 'Tudomásul veszem, hogy a(z) Servixo Solutions Kft. (1081 Budapest, Rákóczi út 63.) adatkezelő által a(z) https://servixosolutionskft.com felhasználói adatbázisában tárolt alábbi személyes adataim átadásra kerülnek a SimplePay Zrt., mint adatfeldolgozó részére. Az adatkezelő által továbbított adatok köre az alábbi: Név, e-mail cím, számlázási cím.\n\nAz adatfeldolgozó által végzett adatfeldolgozási tevékenység jellege és célja a SimplePay Adatkezelési tájékoztatóban, az alábbi linken tekinthető meg: https://simplepay.hu/adatkezelesi-tajekoztatok/',
