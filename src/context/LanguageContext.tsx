...
const translations: Record<Language, Record<string, string>> = {
  EN: {
    ...
    'checkout.section_2': '2. Company Details (Optional)',
    'checkout.company_name': 'Company Name',
    'checkout.tax_number': 'Tax / VAT Number',
    'checkout.section_3': '3. Billing Address (Optional)',
    'checkout.address': 'Street Address (Optional)',
    'checkout.zip': 'Postal Code / ZIP (Optional)',
    'checkout.city': 'City (Optional)',
    'checkout.country': 'Country (Optional)',
  ...
  HU: {
    ...
    'checkout.phone': 'Telefonszám (Opcionális)',
    'checkout.section_2': '2. Céges adatok (Opcionális)',
    'checkout.company_name': 'Cégnév',
    'checkout.tax_number': 'Adószám',
    'checkout.section_3': '3. Számlázási cím (Opcionális)',
    'checkout.address': 'Utca, házszám (Opcionális)',
    'checkout.zip': 'Irányítószám (Opcionális)',
    'checkout.city': 'Város (Opcionális)',
    'checkout.country': 'Ország (Opcionális)',
