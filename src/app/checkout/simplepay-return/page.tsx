...
const EVENT_CONFIG: Record<PaymentEvent, {
  ...
  FAIL: {
    ...
    subtitle: 'Please check that the information entered during the transaction is correct. If all information has been entered correctly, please contact your card-issuing bank to investigate the reason for the rejection.',
  ...
  TIMEOUT: {
    ...
    title:    'Timeout',
    subtitle: 'You exceeded the maximum time available to start the transaction.',
...
export default async function SimplePayReturnPage({ searchParams }: { searchParams: Promise<{ r?: string }> }) {
  ...
  return (
    <>
      ...
      <main className="flex-grow bg-slate-50 dark:bg-slate-950 flex flex-col items-center justify-center py-20 p-6 print:p-0 print:py-0 print:bg-white transition-colors">
