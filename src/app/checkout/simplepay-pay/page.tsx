  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-4 py-8">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        {/* Mobile Compact Order Summary (Takes ~1/4 screen on mobile) */}
        <div className="lg:hidden col-span-1 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 shadow-sm">
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-2">
                  <h2 className="text-base font-bold text-slate-900 dark:text-white truncate">{productName}</h2>
                  <span className="text-[10px] font-semibold px-2 py-0.5 rounded-full bg-indigo-50 dark:bg-indigo-950/80 text-indigo-600 dark:text-indigo-400 border border-indigo-200 dark:border-indigo-800/80 shrink-0">
                    {planTier}
                  </span>
                </div>
                <div className="text-xs text-slate-500 dark:text-slate-400 truncate mt-0.5">OTP Mobil SimplePay • HUF</div>
              </div>
            </div>
            ...
            <div className="text-right shrink-0">
              ...
              <div className="text-[10px] text-slate-400">ÁFA-t tartalmazza</div>
            </div>
          </div>
          ...
          <div className="mt-3 pt-3 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between text-xs text-slate-500 dark:text-slate-400">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[11px]">{t('checkout.ssl_badge')}</span>
            </div>
            <div className="flex items-center gap-2">
              <img
        ...
        {/* Desktop Detailed Order Summary Column (5 cols, visible only on lg screens) */}
        <div className="hidden lg:block lg:col-span-5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-sm sticky top-28">
              ...
              <div className="pt-2 border-t border-slate-200/60 dark:border-slate-800/60 text-center">
                ...
                >
                  <img
                    ...
                    className="h-7 w-auto min-w-[130px] object-contain mx-auto"
                    width={150}
                    height={28}
                  />
                </a>
