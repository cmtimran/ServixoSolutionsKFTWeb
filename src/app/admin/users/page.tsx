  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white mb-2">Users & Access</h1>
          <p className="text-slate-600 dark:text-slate-400">Manage administrator accounts and platform users.</p>
        </div>
        <button
          onClick={() => {
            setUserToEdit(null);
          ...
          className="inline-flex items-center gap-2 px-4 py-2 bg-brand-indigo hover:bg-brand-indigo/90 text-slate-900 dark:text-white font-medium rounded-lg transition-colors shadow-lg shadow-brand-indigo/20"
        >
          ...
          <table className="w-full text-left text-sm text-slate-600 dark:text-slate-400">
            ...
            <tbody className="divide-y divide-slate-800/60">
              {users.length === 0 ? (
                ...
                users.map((user) => (
                  <tr key={user.id} className="hover:bg-slate-50 dark:bg-slate-800/30 transition-colors">
                    ...
                    <td className="px-6 py-4 flex justify-end gap-2">
                      <button
                        ...
                        className="p-2 text-slate-600 dark:text-slate-400 hover:text-blue-400 hover:bg-blue-400/10 rounded-lg transition-colors group relative"
                        title="Edit user"
                      >
