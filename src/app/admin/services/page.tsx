  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-white mb-2">Services Management</h1>
          <p className="text-slate-400">Manage the services displayed on your main website.</p>
        </div>
      ...
      <div className="bg-slate-800/50 border border-slate-700/60 rounded-2xl p-12 backdrop-blur-sm text-center flex flex-col items-center justify-center min-h-[400px]">
        ...
        <h2 className="text-xl font-semibold text-white mb-2">Services Module Pending</h2>
        <p className="text-slate-400 max-w-md mx-auto">
          The services management dashboard is part of the next development phase. You will be able to add, edit, and manage your cloud, software, and cybersecurity services here soon.
        </p>
      </div>
    </div>
  );
