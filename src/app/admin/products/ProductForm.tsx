  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex items-center gap-4">
        <Link href="/admin/products" className="p-2 bg-slate-800 hover:bg-slate-700 text-slate-300 rounded-xl transition-colors">
        ...
        <div>
          ...
          <p className="text-slate-400">Configure product details and pricing tiers.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-slate-800/50 border border-slate-700/60 rounded-2xl p-6 sm:p-8 backdrop-blur-sm space-y-8">
        ...
        <div className="space-y-4 pt-4 border-t border-slate-700/60">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className="space-y-2">
              <label className="text-sm font-medium text-slate-300">Basic Price</label>
              <input
                type="number"
                min="0"
                step="0.01"
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-slate-300">Pro Price</label>
              <input
                type="number"
                min="0"
                step="0.01"
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-slate-300">Enterprise Price</label>
              <input
                type="number"
                min="0"
                step="0.01"
