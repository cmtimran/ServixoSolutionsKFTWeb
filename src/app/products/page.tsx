                ...
                <div className={idx % 2 === 1 ? 'lg:col-start-1 lg:row-start-1' : ''}>
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-3 gap-3 pt-2">
                      {[
                        { tier: 'Basic', price: product.priceBasic },
                        { tier: 'Pro', price: product.pricePro },
                        { tier: 'Enterprise', price: product.priceEnterprise },
                      ].map(({ tier, price }) => (
                        <div key={tier} className="text-center p-3 rounded-xl" style={{ background: 'var(--bg-inset)', border: '1px solid var(--border)' }}>
                          ...
                          <div className="text-[9px]" style={{ color: 'var(--text-subtle)' }}>/month</div>
                        </div>
                      ))}
                    </div>
        ...
        <section id="pricing" className="py-20 px-4 sm:px-6 lg:px-8" style={{ background: 'var(--bg-surface)' }}>
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              {[
                { tier: 'Basic', desc: 'For startups and small teams.', price: 'from $49', features: ['Up to 5 users', 'Core modules', 'Email support', '99.9% SLA'] },
                { tier: 'Pro', desc: 'For growing businesses.', price: 'from $149', features: ['Up to 50 users', 'All modules + API', 'Priority support', '99.95% SLA'], featured: true },
                { tier: 'Enterprise', desc: 'For large corporations.', price: 'Custom', features: ['Unlimited users', 'Custom integrations', 'Dedicated success manager', '99.99% SLA'] },
              ].map((plan) => (
                <div
                  key={plan.tier}
                ...
                >
                  ...
                  <CheckoutButton
                    productName="Servixo Enterprise Subscription"
                    planTier={plan.tier}
                    price={plan.price}
